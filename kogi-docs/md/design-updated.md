...
gRPC server:
EngineGrpcServer (default port 9100)
Methods: Control, Status, Ingest, Snapshot
Wire format: google.protobuf.Struct
Reflection: enabled by default; disable with KOGI_ENGINE_GRPC_REFLECTION=off
Proto metadata: KOGI_ENGINE_GRPC_PROTO (optional)
