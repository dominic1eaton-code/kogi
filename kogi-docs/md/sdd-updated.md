...
**Shared Portfolios & Portfolio Collaboration:**

| Feature | Description |
|---|---|
| **Shared Portfolio** | A portfolio jointly owned, managed, or contributed to by multiple users, teams, organizations, collectives, cooperatives, or federations. Shared portfolios inherit the full PortfolioComponent data model and governance system. |
| **Portfolio Types** | Personal · Team · Organization · Collective · Cooperative · Federation |
| **Collaboration Roles** | Owner · Co-owner · Editor · Contributor · Viewer · Investor · Donor · Subscriber · Follower |
| **Portfolio Resource Sharing** | Members can share artifacts, templates, playbooks, tools, contracts, and data resources within a shared portfolio context. Resource access is governed by per-component policy rules. |
| **Crowdresourced Components** | Portfolio items can receive crowdresourced contributions (labor, capital, assets, knowledge) from the broader Kogi community through the Marketplace and Exchange. |
| **Group / Team / Coop / Federation Portfolios** | Each organizational entity type (group, collective, cooperative, autonomous org, federation) has its own portfolio namespace and governance model, backed by the same PortfolioComponent infrastructure. |
| **Contribution Attribution** | All contributions to a shared portfolio are tracked with full attribution, versioned, and factored into equity/revenue distribution calculations via kogi-bank. |
| **Forking & Templating** | Any shared portfolio component can be forked to create an independent derivative, or templated and published to the Marketplace for reuse. |
...
- Powers shared portfolios and collaborative portfolio management across organizations
...
| Booking & Scheduling | Centralized calendars, multi-worker dashboards, conflict detection, event booking and reservation management |
| CRM & Lead Management | Lead capture forms, automated follow-up emails, client database management, pipeline management |
| Contracts & Invoicing | Customizable automated contracts with e-signatures, automated payment reminders, invoice management |
| Logistics & Communication | Tour and project itinerary planning, resource allocation (equipment/staff), in-app communication, logistics tracking (equipment rentals, transportation, crew schedules) |
| Finance & Reporting | Online payment processing, expense tracking, budget management, tax report generation |

**Portable Benefits System (kogi-benefits):**

Portable benefits are worker-centered benefits that remain with an individual rather than being tied to a single employer, designed for independent contractors, freelancers, and gig workers.

| Benefit Category | Details |
|---|---|
| **Health & Wellness** | Health insurance, dental insurance, vision insurance, Health Savings Accounts (HSAs) |
| **Retirement & Savings** | SEP-IRA, 401k portability, Pooled Employer Plans (PEPs), emergency savings accounts |
| **Paid Time Off & Income Security** | Paid sick days, paid vacation time, income replacement for missed work |
| **Insurance & Protection** | Occupational accident insurance, disability coverage, workers' compensation |
| **Professional Development** | Portable education accounts, training fund, certification credits |
| **Platform Contributions** | Tracking gig platform % contributions (e.g., 4% of pre-tip earnings) to portable savings accounts managed by benefit providers (e.g., Stride LLC) |

**Benefits Data Model:**
```
BenefitsAccount
├── benefit_type: health | dental | vision | hsa | retirement | pto | disability | professional_dev | savings
├── provider: string (insurance company, retirement platform, HSA custodian)
├── contribution_source[]: { source_id, source_type (employer | platform | self), amount, pct, frequency }
├── balance | coverage_amount | coverage_details
├── vesting_schedule (for retirement accounts)
├── eligibility_rules: PolicySet
└── linked_account_id → kogi-bank account
```
...
- Portable benefits accounts linked to kogi-bank for contribution tracking and disbursement
...
- **Group Economics** — cooperative treasury management, shared fund accounts, collective revenue sharing, group investment pools
- **Shared Portfolios** — group, team, organization, collective, cooperative, and federation portfolio management and collaboration
- **Portfolio Resource Sharing** — members share artifacts, tools, contracts, playbooks, templates, and data resources within a space
- **Portfolio Collaboration** — multi-contributor portfolio items with attribution tracking, contribution ledgers, and governance-controlled merge/fork workflows
- **Equity Crowdfunding** — Reg CF campaigns, revenue share instruments, SAFE notes, investor cap table management
- **Crowdresourcing** — community-sourced labor, capital, assets, and knowledge contributions to portfolio items
- **Grants & Microfinancing** — grant application management, microloan tracking, impact reporting, community grant pools
- **Initiatives** — platform-coordinated programs for portable benefits, group economics, and collective action
...
`users · independent workers · organizations · teams · communities · contributors · investors · donors · cooperatives · collectives · federations · autonomous orgs`
...
- Financial flows (campaigns, distributions, grants) → kogi-bank
...
- **Equity Crowdfunding** — Reg CF campaigns, revenue share instruments, SAFE notes, convertible instruments; investor cap table management via kogi-bank
- **Grants & Microfinancing** — grant discovery, application submission, eligibility scoring via kogi-engine; microloan origination and repayment tracking
- **Group Economics** — cooperative group buys, collective bids, shared-cost resource acquisition, community investment pools
- **Crowdresourcing** — community-sourced labor, asset, and knowledge contributions; contribution tracking and attribution ledger
- **Shared Portfolios** — list and transact on shared portfolio components; group and federation portfolio items available for investment or collaboration

**Supported Participant Types:**
`investors · donors · freelancers · gig workers · contractors · organizations · collectives · cooperatives · federations · grant providers · microfinance lenders`

**Integrations:**
- Payment and funding flows → kogi-pay / kogi-bank
- Worker profiles → kogi-gig
- Portfolio assets → kogi-portfolio
- Community visibility → kogi-community
- Equity + grant instruments → kogi-bank (escrow, cap table, ledger)
...
- **Portable Benefits Accounts** — HSA management, retirement savings (SEP-IRA, 401k, PEP), portable savings account with gig contribution tracking, income protection fund, professional development account
- **Grants & Microfinancing** — grant fund disbursement, microloan origination and repayment, impact fund management, grant reporting ledger
- **Group Economics** — cooperative treasury management, shared fund accounts, collective revenue distribution, group investment pool ledgers, multi-sig treasury controls
- **Equity Crowdfunding** — Reg CF campaign wallets, revenue share instruments, SAFE / convertible note management, investor cap table, payout distribution engine
- **Crowdresourcing Accounts** — resource pooling accounts, contribution ledgers, crowdresourced-value attribution and settlement

**Integrations:**
- Marketplace deal → payment pipeline
- Gig (payroll/self-pay/tax estimates)
- Portfolio (financial KPIs)
- Portable benefits → benefits provider integrations (Stride LLC, Catch, etc.)
- Equity crowdfunding → cap table management, payout automation
- Grants → grant-provider disbursement integrations
