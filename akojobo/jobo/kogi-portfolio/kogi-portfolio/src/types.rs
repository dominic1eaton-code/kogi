...
pub enum ActionKind {
    ...
    // Economic — amounts stored as integer cents to avoid f64 Eq issues
    Donate { amount_cents: i64, currency: String },
    Invest { amount_cents: i64, currency: String, equity: bool },
    // Access
