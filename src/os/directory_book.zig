...
pub const DirectoryEntry = struct {
    ...
    linked_note_ids: std.array_list.Managed(u32),
    relationships: std.array_list.Managed(RelationshipLink),
    active: bool,
    created_at: i64,
    updated_at: i64,
};
...
pub const DirectoryOrganization = struct {
    ...
    industry: []const u8,
    notes: []const u8,
    entry_ids: std.array_list.Managed(u32),
    active: bool,
    created_at: i64,
    updated_at: i64,
};
...
pub const DirectoryBookManager = struct {
    ...
    organizations: std.array_list.Managed(DirectoryOrganization),
    next_entry_id: u32,
    next_org_id: u32,
    ...
    pub fn init(allocator: std.mem.Allocator) DirectoryBookManager {
        return DirectoryBookManager{
            .allocator = allocator,
            .entries = std.array_list.Managed(DirectoryEntry).init(allocator),
            .organizations = std.array_list.Managed(DirectoryOrganization).init(allocator),
            .next_entry_id = 0,
            .next_org_id = 0,
        };
    }
    ...
    pub fn createEntry(
        ...
        const entry = DirectoryEntry{
            ...
            .linked_note_ids = std.array_list.Managed(u32).init(self.allocator),
            .relationships = std.array_list.Managed(RelationshipLink).init(self.allocator),
            .active = true,
            .created_at = now,
            .updated_at = now,
        };
    ...
    pub fn createOrganization(self: *DirectoryBookManager, owner_user_id: u32, name: []const u8, industry: []const u8, notes: []const u8) !u32 {
        ...
        const org = DirectoryOrganization{
            ...
            .notes = try self.allocator.dupe(u8, notes),
            .entry_ids = std.array_list.Managed(u32).init(self.allocator),
            .active = true,
            .created_at = now,
            .updated_at = now,
        };
