...
pub fn sample_dashboard_snapshot() -> WalletDashboardSnapshot {
    WalletDashboardSnapshot {
        summary_cards: vec![
            DashboardMetric { label: "Net Worth".into(), value: "$142,800".into(), meta: "▲ 4.2% · 30d".into(), tone: "text-[#10b981]".into() },
            DashboardMetric { label: "Liquid Cash".into(), value: "$28,400".into(), meta: "Checking  Ops".into(), tone: "text-[#e6f1f4]".into() },
            DashboardMetric { label: "Invested".into(), value: "$89,200".into(), meta: "▲ 1.8% · 7d".into(), tone: "text-[#06b6d4]".into() },
